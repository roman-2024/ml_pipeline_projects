...
class DataTransformationConfig:
    preprocess_obj_file_path=os.path.join("artifacts/data_transformation","preprecessor.pkl")
...
class DataTransformation:
    ...
    def inititate_data_transformation(self,train_path,test_path):
        ...
        'capital_loss', 'hours_per_week', 'native_country']
            ...
            #apply Tranformation on our train data and test data
            ...
            #Apply preprocessor on our train data and test data
